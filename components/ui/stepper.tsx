    ...
    return (
      <StepperContext.Provider
        ...
        <div
          ref={ref}
          className={cn(
            'group/stepper inline-flex md:w-full md:flex-row flex-col',
            className
          )}
    ...
    return (
      <StepItemContext.Provider
        ...
        <div
          ref={ref}
          className={cn(
            'group/step flex items-center md:flex-row flex-col',
            className
          )}
          data-state={state}
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        'm-0.5 bg-none border-0 group-data-[state=completed]/step:border h-16 md:w-0.5 md:h-0 md:flex-1 group-data-[state=completed]/step:border-dashed',
        className
      )}
      {...props}
    />
